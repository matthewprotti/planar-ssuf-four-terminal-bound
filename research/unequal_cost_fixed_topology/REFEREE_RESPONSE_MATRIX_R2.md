...
| P1.1 | Rewrite cost reduction using \(k_i=e_i-b_i>0\) and identify excluded cases. | Positivity is now stated as a genuine restriction throughout. | `POSITIVE_DIFFERENCE_SCOPE.md`; README title/domain; UC-001 | UC-001, UC-008 | Artifact text validation | Zero and negative differences remain open. |
...
| R2-12 | Positivity was not proved WLOG or clearly advertised as restriction. | Advertised explicitly as a genuine restriction; renamed package/theorem scope. | `POSITIVE_DIFFERENCE_SCOPE.md`; README; UC-001/UC-008 wording | UC-001, UC-008 | Text validation | Zero/negative cases open. |
| R2-13 | Principal theorem boundary was difficult to infer. | Added theorem ledger with full statements, assumptions, locations, evidence class, and residuals. | `THEOREM_LEDGER.md`; `CLAIM_LEDGER.md` | All UC claims | Ledger ID check | 94-cell conjecture remains open. |
...
| R2-15 | Boundary/closure protocol was only a plan. | Labeled it methodology and enumerated which domains remain unhandled. | `CELL_OPTIMIZATION_PROTOCOL.md`; theorem ledger | UC-020/UC-021 | Text validation | No remaining cell or boundary is claimed solved. |
